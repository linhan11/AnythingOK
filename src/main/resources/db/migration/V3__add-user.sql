...
ALTER TABLE loto6infos ADD username VARCHAR(100) NOT NULL DEFAULT 'user1';
ALTER TABLE loto6infos ADD CONSTRAINT FK_LOTO6INFOS_USERNAME FOREIGN KEY (username) REFERENCES users;